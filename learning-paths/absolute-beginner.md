# Absolute Beginner Learning Path

> For learners with **basic Python knowledge** and **no prior ML experience**.

## Path Overview

The goal is to build a solid foundation in ML concepts, complete 2–3 projects, and gain confidence to move to intermediate topics.
...
## Phase 3 — Apply & Extend (Months 7–12)
...
- Can explain train/test split, overfitting, and cross-validation
- Can train a model in sklearn and PyTorch
- Has 2+ projects on GitHub with README
- Able to read and summarize a beginner-level blog post on ML
