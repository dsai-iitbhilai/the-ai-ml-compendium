...
> End-to-end examples of data science applied to real-world problems. Each case ties together data collection, wrangling, EDA, statistics, feature engineering, modeling, and communication.
...
|------|-----------|-----------|
| Load & inspect | pandas | 5 min |
| Missing values | Imputation | 15 min |
| Feature engineering | Family size, title extraction | 15 min |
| EDA | Seaborn visualizations | 20 min |
| Baseline model | Logistic Regression | 10 min |
| Model comparison | Random Forest, XGBoost | 20 min |
| Explainability | SHAP | 15 min |
...
| Step | Technique | Est. Time |
|------|-----------|-----------|
| SQL extraction | CTEs, joins | 20 min |
| Cleaning | Pandas | 15 min |
| CTR Analysis | Confidence intervals | 20 min |
| A/B Testing | Hypothesis testing | 20 min |
| Segmentation | RFM + KMeans | 25 min |
| Dashboard | Streamlit | 30 min |
...
| Project | Description |
|------|-------------|
| Kaggle Competition | Complete notebook from EDA to submission |
| Data Journalism | Reproduce a FiveThirtyEight article |
| Churn Prediction | Production-ready ML pipeline |
| Recommendation System | MovieLens collaborative filtering |
| Fraud Detection | End-to-end imbalanced classification |
...
- [03 – Machine Learning](../03-machine-learning/README.md)
- [08 – Projects & Examples](../08-projects-and-examples/README.md)