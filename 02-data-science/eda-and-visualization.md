...
> Explore data through statistics and visual storytelling. Learn to uncover patterns, detect anomalies, validate assumptions, and communicate insights using Python visualization libraries.

**Last Reviewed:** 2026-06

**Prerequisites:** [Data Wrangling](data-wrangling.md)
...
| Project | Skills |
|----------|--------|
| Titanic EDA | Missing values, distributions, correlations |
| Netflix Dataset Analysis | Categorical analysis and visual storytelling |
| House Prices EDA | Correlations, feature relationships |
| COVID Dashboard | Time series and interactive charts |
| Sales Dashboard | Plotly + Streamlit |
| Palmer Penguins Report | Complete EDA with statistical interpretation |
...
8. Interactive Plotly
9. Dashboard Building
10. End-to-End EDA Reports
...
- [Visualizers & Playgrounds](../visualizers-and-playgrounds/README.md)