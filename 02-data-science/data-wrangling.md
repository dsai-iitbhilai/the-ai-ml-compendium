...
> Transforming raw, messy data into clean, reliable, and analysis-ready datasets. Covers pandas, NumPy, missing data, reshaping, joins, feature preparation, and reproducible data pipelines.
...
- [ ] Series
- [ ] DataFrames
- [ ] Reading CSV/Excel/JSON/Parquet
...
| Project | Skills |
|----------|--------|
| Titanic Data Cleaning | Missing values, encoding, joins |
| Adult Income Dataset | Cleaning + preprocessing |
| House Prices | Feature preparation |
| NYC Taxi Analysis | Dates, aggregation, missing values |
| Sales Dashboard | Merge multiple CSV files and summarize |
| Data Cleaning Pipeline | Build reusable preprocessing functions |
...
10. End-to-End Cleaning Projects
...
- [Python for AI](../01-foundations/programming/python-for-ai.md)