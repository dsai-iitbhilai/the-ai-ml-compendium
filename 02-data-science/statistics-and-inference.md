...
> Learn how to draw reliable conclusions from data using probability, sampling, hypothesis testing, confidence intervals, effect sizes, and statistical modeling. Statistics forms the mathematical foundation of Data Science, Machine Learning, A/B Testing, and scientific experimentation.

**Last Reviewed:** 2026-06

**Prerequisites:** [01 – Foundations / Probability & Statistics](../01-foundations/mathematics/probability-statistics.md) · [EDA & Visualization](eda-and-visualization.md)
...
| Project | Description |
|----------|-------------|
| A/B Test Analysis | Perform hypothesis testing, confidence intervals, and power analysis on simulated experiments |
| Bootstrap Confidence Intervals | Estimate confidence intervals using bootstrap resampling |
| Analyze Public Survey Data | Perform descriptive and inferential statistical analysis on survey datasets |
| Compare Statistical Tests | Apply t-tests, ANOVA, and non-parametric tests on the same dataset |
| Election Poll Analysis | Estimate confidence intervals and sampling error from polling data |
| Bayesian vs Frequentist Comparison | Solve the same inference problem using both approaches |
...
4. Seeing Theory
5. StatQuest Playlist
6. Penn State STAT Online
7. SciPy & statsmodels Documentation
8. ISLR (Inference Chapters)
9. Harvard Statistics 110
10. Casella & Berger (Advanced)
...
- [SQL & Databases](sql-and-databases.md)
- [Model Evaluation](../03-machine-learning/model-evaluation.md)
- [Probability & Statistics](../01-foundations/mathematics/probability-statistics.md)