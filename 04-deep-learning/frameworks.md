...
> Modern deep learning frameworks and their ecosystems. Learn how to build, train, optimize, and deploy deep learning models using PyTorch, TensorFlow, JAX, and related tools.
...
| Project | Skills |
|----------|--------|
| Build an MLP in PyTorch | Tensor basics |
| CNN with TensorFlow | Keras workflow |
| Transformer using PyTorch | NLP |
| ResNet Training | Computer Vision |
| Mixed Precision Training | Performance optimization |
| Multi-GPU Training | Distributed systems |
| Export Model to ONNX | Deployment |
| Image Classification API | FastAPI + PyTorch |
| Hugging Face Fine-tuning | Transformers |
| Experiment Tracking with W&B | MLOps |
